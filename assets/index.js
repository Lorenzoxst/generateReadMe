...
const questions = () => {
    ...
    },
    {
        ...
        type: "list",
        choices: ["Apache License 2.0", "GNU GPLv3", "MIT License", "The Unlicense"],
        name: "license"
    },
    {
...
function init() {
    questions()
        .then((data) => fs.writeFile("README.md", generateMarkdown(data) ))
        .then(() => console.log('Successfully wrote and generated readme'))
